...
%% Page formatting %%
\geometry{margin=0.25in} % set page margins
...
\begin{document}
    ...
    \begin{center}
        ...
        % \href{https://www.linkedin.com/in/natanielfarzan}{LinkedIn Profile} $\bullet$
        \href{https://www.linkedin.com/in/natanielfarzan}{linkedin.com/in/natanielfarzan} $\bullet$
        % \href{https://github.com/natanielf}{GitHub Profile} $\bullet$
