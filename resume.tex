...
\begin{document}
    ...
    \vspace{4pt}
    \noindent
    \begin{minipage}[c]{0.152\linewidth}
        \noindent Python \\
        \noindent Git/GitHub \\
    \end{minipage}
    \begin{minipage}[c]{0.152\linewidth}
    ...
    \noindent
    \begin{itemize}[noitemsep, topsep=0pt]
        \item Reviewed current system-level visualization libraries and techniques
        \item Documented the development of Netmemvisual, a deep neural network visualization tool
        \item Presented experimental results and analysis of two state-of-the-art computer vision networks
    \end{itemize}
    \medskip
